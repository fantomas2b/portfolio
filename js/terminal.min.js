...
(function(c) {
  c.fn.t = function(l, I) {
    return this.each(function() {
      ...
      !e(d) && (d = g.shift());
      g.push("\u200b");
      "de" == a.locale && (y = '12qwertzuiop\u00fc+asdfghjkl\u00f6\u00e4#<yxcvbnm,.-!"\u00a7$%&/(()=?1234567890\u00df*p+');
      var J = E() + 1;
      ...
      q.data("ti", H = setInterval(function() {
        ...
        if (++A >= n.data("speed") / 10)
          ...
          for (;;)
            if (!0 === n.data().beep && f.beep(), b.append(d), G && a.typing(n, d, E(), J), !/<ins.*?>[\s\S]+</.test(d) && /></.test(d) && (b = b.find(":last")), (_ss = b.data("speed")) && n.s(_ss), g[0] && /<\w+/.test(g[0])) d = g.shift();
            else break;
