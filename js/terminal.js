      ...
      return this.each(function() {
        ...
        if (_c == 'add' && c.data().t) {
          ...
          if (_o.wrap && !c.parent().data().t_wrap) {
            c.wrap($('<div/>', (/[.#]/.test(_o.wrap[0])) ? ((_o.wrap[0] == '#') ? {
              'id': _o.wrap.substr(1)
            } : {
          ...
          if (t(_o.caret, 's') && !$('.t-caret', c)[0]) {
            ...
            _o.blink && c.append(z) && (c.data('bi', bi = setInterval(function() {
              ...
              if ((C.data().blinking | (v = (oo.css('visibility')[0] == 'h'))) || _o.blink_perm) oo.css({
